...
export class EditComponent {
  http = inject(HttpClient);
    ...
    serviciosDisponibles = [
      { id: 1, nombre: 'Televisión en asiento' },
      { id: 3, nombre: 'Comida y bebida' },
      { id: 4, nombre: 'Wifi' },
      { id: 5, nombre: 'Auriculares' },
      { id: 6, nombre: 'Acceso a salas VIP' },
      { id: 7, nombre: 'Almohadas y mantas' },
      { id: 8, nombre: 'Ásistencia para personas con discapacidad' },
      { id: 9, nombre: 'Cargador para dispositivos' }
    ];
