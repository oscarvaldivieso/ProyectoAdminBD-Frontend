...
export class EditComponent {
  http = inject(HttpClient);
      ...
      serviciosDisponibles = [
        { id: 10, nombre: 'Atención personalizada' },
        { id: 11, nombre: 'Entrantes o aperitivos' },
        { id: 12, nombre: 'Menú para niños' },
        { id: 13, nombre: 'Decoración temática' },
        { id: 14, nombre: 'Servicio de reservas' },
        { id: 15, nombre: 'Áreas climatizadas' },
        { id: 16, nombre: 'Área al aire libre' },
        { id: 17, nombre: 'Mesas para grupos grandes' }
      ];
